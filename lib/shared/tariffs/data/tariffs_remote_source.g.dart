part of 'tariffs_remote_source.dart';
...
class _TariffsRemoteSource implements TariffsRemoteSource {
  _TariffsRemoteSource(this._dio, {this.baseUrl, this.errorLogger});
