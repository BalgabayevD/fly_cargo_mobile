...
@useResult
$Res call({
 int id, String createdAt, String updatedAt, int fromCityId, double fromLatitude, double fromLongitude, String fromAddress, int toCityId, double toLatitude, double toLongitude, String toAddress, int tariffId, bool isPaid, bool isFragile, bool isDefect, double volumetricWeight, double weight, double width, double length, double height, int calculationId, String? deletedAt, String? status, String fromApartment, String? fromEntrance, String fromFloor, String toApartment, String? toEntrance, String toFloor, String? toPhone, String? toName, double? price, TariffModel? tariff, String? sendTime, String comment, String description, String category, List<String> photos, List<String> contentPhotos, List<String>? defectPhotos, CityModel? fromCity, CityModel? toCity, List<ParticipantModel> participants, List<QrModel>? qrs, PriceCalculationModel? priceCalculations
});
...
as List<String>?,fromCity: freezed == fromCity ? _self.fromCity : fromCity // ignore: cast_nullable_to_non_nullable
...
as List<QrModel>?,priceCalculations: freezed == priceCalculations ? _self.priceCalculations : priceCalculations // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  String createdAt,  String updatedAt,  int fromCityId,  double fromLatitude,  double fromLongitude,  String fromAddress,  int toCityId,  double toLatitude,  double toLongitude,  String toAddress,  int tariffId,  bool isPaid,  bool isFragile,  bool isDefect,  double volumetricWeight,  double weight,  double width,  double length,  double height,  int calculationId,  String? deletedAt,  String? status,  String fromApartment,  String? fromEntrance,  String fromFloor,  String toApartment,  String? toEntrance,  String toFloor,  String? toPhone,  String? toName,  double? price,  TariffModel? tariff,  String? sendTime,  String comment,  String description,  String category,  List<String> photos,  List<String> contentPhotos,  List<String>? defectPhotos,  CityModel? fromCity,  CityModel? toCity,  List<ParticipantModel> participants,  List<QrModel>? qrs,  PriceCalculationModel? priceCalculations)  $default,) {final _that = this;
switch (_that) {
case _OrderModel():
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.fromCityId,_that.fromLatitude,_that.fromLongitude,_that.fromAddress,_that.toCityId,_that.toLatitude,_that.toLongitude,_that.toAddress,_that.tariffId,_that.isPaid,_that.isFragile,_that.isDefect,_that.volumetricWeight,_that.weight,_that.width,_that.length,_that.height,_that.calculationId,_that.deletedAt,_that.status,_that.fromApartment,_that.fromEntrance,_that.fromFloor,_that.toApartment,_that.toEntrance,_that.toFloor,_that.toPhone,_that.toName,_that.price,_that.tariff,_that.sendTime,_that.comment,_that.description,_that.category,_that.photos,_that.contentPhotos,_that.defectPhotos,_that.fromCity,_that.toCity,_that.participants,_that.qrs,_that.priceCalculations);}
}
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,fromCityId,fromLatitude,fromLongitude,fromAddress,toCityId,toLatitude,toLongitude,toAddress,tariffId,isPaid,isFragile,isDefect,volumetricWeight,weight,width,length,height,calculationId,deletedAt,status,fromApartment,fromEntrance,fromFloor,toApartment,toEntrance,toFloor,toPhone,toName,price,tariff,sendTime,comment,description,category,const DeepCollectionEquality().hash(_photos),const DeepCollectionEquality().hash(_contentPhotos),const DeepCollectionEquality().hash(_defectPhotos),fromCity,toCity,const DeepCollectionEquality().hash(_participants),const DeepCollectionEquality().hash(_qrs),priceCalculations]);
