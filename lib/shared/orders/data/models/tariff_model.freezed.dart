...
mixin _$TariffModel {
 ...
 int? get id; String get createdAt; String get updatedAt; String? get deletedAt; bool get isActive; String get name; String get description; int? get icon; String get image; int? get sortIndex; List<String>? get fields; int? get tariffCategoryId; double? get length; double? get height; double? get width; double? get volumetricWeight; double? get weight; double? get invoiceWeight; double? get costPriceOfAirShipment; int? get packageId; double? get additionalCostForFragileCargo; TariffCategoryModel? get tariffCategory; PackageModel? get package;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,deletedAt,isActive,name,description,icon,image,sortIndex,const DeepCollectionEquality().hash(fields),tariffCategoryId,length,height,width,volumetricWeight,weight,invoiceWeight,costPriceOfAirShipment,packageId,additionalCostForFragileCargo,tariffCategory,package]);

@override
String toString() {
  return 'TariffModel(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, deletedAt: $deletedAt, isActive: $isActive, name: $name, description: $description, icon: $icon, image: $image, sortIndex: $sortIndex, fields: $fields, tariffCategoryId: $tariffCategoryId, length: $length, height: $height, width: $width, volumetricWeight: $volumetricWeight, weight: $weight, invoiceWeight: $invoiceWeight, costPriceOfAirShipment: $costPriceOfAirShipment, packageId: $packageId, additionalCostForFragileCargo: $additionalCostForFragileCargo, tariffCategory: $tariffCategory, package: $package)';
}
...
@useResult
$Res call({
 int? id, String createdAt, String updatedAt, String? deletedAt, bool isActive, String name, String description, int? icon, String image, int? sortIndex, List<String>? fields, int? tariffCategoryId, double? length, double? height, double? width, double? volumetricWeight, double? weight, double? invoiceWeight, double? costPriceOfAirShipment, int? packageId, double? additionalCostForFragileCargo, TariffCategoryModel? tariffCategory, PackageModel? package
});
...
/// Create a copy of TariffModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? createdAt = null,Object? updatedAt = null,Object? deletedAt = freezed,Object? isActive = null,Object? name = null,Object? description = null,Object? icon = freezed,Object? image = null,Object? sortIndex = freezed,Object? fields = freezed,Object? tariffCategoryId = freezed,Object? length = freezed,Object? height = freezed,Object? width = freezed,Object? volumetricWeight = freezed,Object? weight = freezed,Object? invoiceWeight = freezed,Object? costPriceOfAirShipment = freezed,Object? packageId = freezed,Object? additionalCostForFragileCargo = freezed,Object? tariffCategory = freezed,Object? package = freezed,}) {
...
switch (_that) {
case _TariffModel() when $default != null:
return $default(_that.id,_that.createdAt,_that.updatedAt,_that.deletedAt,_that.isActive,_that.name,_that.description,_that.icon,_that.image,_that.sortIndex,_that.fields,_that.tariffCategoryId,_that.length,_that.height,_that.width,_that.volumetricWeight,_that.weight,_that.invoiceWeight,_that.costPriceOfAirShipment,_that.packageId,_that.additionalCostForFragileCargo,_that.tariffCategory,_that.package);case _:
  return orElse();
...
class _TariffModel implements TariffModel {
  const _TariffModel({this.id, required this.createdAt, required this.updatedAt, this.deletedAt, required this.isActive, required this.name, required this.description, this.icon, required this.image, this.sortIndex, final  List<String>? fields, this.tariffCategoryId, this.length, this.height, this.width, this.volumetricWeight, this.weight, this.invoiceWeight, this.costPriceOfAirShipment, this.packageId, this.additionalCostForFragileCargo, this.tariffCategory, this.package}): _fields = fields;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,createdAt,updatedAt,deletedAt,isActive,name,description,icon,image,sortIndex,const DeepCollectionEquality().hash(_fields),tariffCategoryId,length,height,width,volumetricWeight,weight,invoiceWeight,costPriceOfAirShipment,packageId,additionalCostForFragileCargo,tariffCategory,package]);
