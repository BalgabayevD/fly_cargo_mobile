...
part of 'orders_remote_source.dart';
...
class _OrdersRemoteSource implements OrdersRemoteSource {
  ...
  @override
  Future<PreCreateOrderResult> createOrderPre(List<MultipartFile> files) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
    _data.files.addAll(files.map((i) => MapEntry('file', i)));
    final _options = _setStreamType<PreCreateOrderResult>(
      Options(
            method: 'POST',
            headers: _headers,
            extra: _extra,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late PreCreateOrderResult _value;
    try {
      _value = PreCreateOrderResult.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<CalculateOrderPriceResponse> calculateOrderPrice(
    ...
    final _data = <String, dynamic>{};
    _data.addAll(body);
    final _options = _setStreamType<CalculateOrderPriceResponse>(
      Options(method: 'POST', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/api/v1/orders/price',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late CalculateOrderPriceResponse _value;
    try {
      _value = CalculateOrderPriceResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<FileUploadResponse> uploadOrderPhoto(MultipartFile file) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = FormData();
  ...
  @override
  Future<OrdersResponse> getClientOrders() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
  ...
  @override
  Future<OrdersResponse> getCourierOrders() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<OrdersResponse> getCreatedOrders() async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
