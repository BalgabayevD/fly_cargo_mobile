...
@override
String toString() {
  return 'OrderHistoryEntity(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, orderId: $orderId, status: $status, userId: $userId, comment: $comment)';
}
...
class _OrderHistoryEntity implements OrderHistoryEntity {
  const _OrderHistoryEntity({this.id, this.createdAt, this.updatedAt, this.orderId, this.status, this.userId, this.comment});
