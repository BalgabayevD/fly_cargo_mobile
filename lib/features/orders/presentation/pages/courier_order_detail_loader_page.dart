...
class CourierOrderDetailLoaderPage extends StatefulWidget {
  ...
  const CourierOrderDetailLoaderPage({
    required this.orderId,
    super.key,
  });

  @override
  State<CourierOrderDetailLoaderPage> createState() =>
      _CourierOrderDetailLoaderPageState();
}

class _CourierOrderDetailLoaderPageState
    extends State<CourierOrderDetailLoaderPage> {
  @override
  void initState() {
    super.initState();
