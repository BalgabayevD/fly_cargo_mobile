...
class AppColors {
  ...
  static const Color primary = Color(0xFFE47B35); // #E47B35 - главный оранжевый
  static const Color primaryLight = Color(0xFFFF9A5C); // Светлый оранжевый
  static const Color primaryDark = Color(0xFFC86020); // Темный оранжевый
  static const Color secondary = Color(0xFFFFE4D2); // #FFE4D2 - вторичный светло-оранжевый
  static const Color secondaryLight = Color(0xFFFFF3E9); // Очень светлый оранжевый
  static const Color secondaryDark = Color(0xFFFFD1B3); // Средний светло-оранжевый
  ...
  // Системные цвета
  static const Color success = Color(0xFF34C759); // Зеленый для успеха
  static const Color warning = Color(0xFFFFC107); // Желтый для предупреждений
  static const Color error = Color(0xFFFF3B30); // Красный для ошибок
  ...
  static const Color selected = Color(0xFFE47B35); // Используем primary
  static const Color hover = Color(0xFFFF9A5C); // Используем primaryLight
  static const Color pressed = Color(0xFFC86020); // Используем primaryDark
  ...
  static const Color accentOrange = Color(0xFFE47B35); // Используем primary
